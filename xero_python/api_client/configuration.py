...
class Configuration(metaclass=TypeWithDefault):
    ...
    def __init__(self, debug=False, oauth2_token=None):
        """Constructor"""
        ...
        self.oauth2_token = oauth2_token  # type: Optional[OAuth2Token]

        # Logging Settings
        self.logger = {"package_logger": logging.getLogger("xero_python")}
        # Log format
